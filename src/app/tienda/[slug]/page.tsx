        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              <h1 className="font-heading text-5xl md:text-6xl leading-none mb-4">
            ...
            {product.stock > 0 ? (
              ...
              <p className="text-sm uppercase tracking-widest text-muted border border-border px-6 py-4 text-center">
                Sin stock
              </p>
            )}
          </div>
